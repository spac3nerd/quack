quack.math.matrix4 = function() {
	...
	this.rotateX = function(angle) {
		this.multMatrices(this, new quack.math.matrix4().setRotateX(angle));
	...
	this.rotateY = function(angle) {
		this.multMatrices(this, new quack.math.matrix4().setRotateY(angle));
	...
	this.rotateZ = function(angle) {
		this.multMatrices(this, new quack.math.matrix4().setRotateZ(angle));
